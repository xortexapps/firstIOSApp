...
$cacheFolder = realpath('../../cache/');
$file = $cacheFolder . "/tiles/$r/$z/$x/$y.png";
$img = null;
$tries = 0;
if (!is_file($file) || filemtime($file) < time()-(86400*30)) {
    do {
        ...
        switch ($r) {
            ...
            case 'cycle':
                $server[] = 'a.tile.opencyclemap.org/cycle';
                $server[] = 'b.tile.opencyclemap.org/cycle';
                $server[] = 'c.tile.opencyclemap.org/cycle';
